<?php
/*
Template name: impermiabilizantes
*/
?>
		...
		<section class="contenidoCentral">
			...
			<a href="#">
				<div class="revestimientos">
					<h2>FRENTES Y MUROS <small>ver m&aacute;s / <span>comprar</span></small></h2>
				</div> <!-- End of revestimientos -->
			</a>

			<a href="#">
				<div class="revestimientos">
					<h2>MEMBRANAS EN PASTA <small>ver m&aacute;s / <span>comprar</span></small></h2>
				</div> <!-- End of revestimientos -->
			</a>
