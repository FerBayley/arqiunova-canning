...
<section id="contenido">
		...
		<section class="contenidoCentral">
			...
			<hgroup>
				<h2>REVESTIMIENTOS PLASTICOS Y TEXTURADOS</h2>
			</hgroup>

			<a href="#">
				<div class="revestimientos">
					<h2>ITALFLEX <small>ver m&aacute;s / <span>comprar</span></small></h2>
				</div> <!-- End of revestimientos -->
			</a>

			<a href="#">
				<div class="revestimientos">
					<h2>RUSTIFLEX <small>ver m&aacute;s / <span>comprar</span></small></h2>
				</div> <!-- End of revestimientos -->
			</a>

			<a href="#">
				<div class="revestimientos">
					<h2>NEOFLEX <small>ver m&aacute;s / <span>comprar</span></small></h2>
				</div> <!-- End of revestimientos -->
			</a>

			<a href="#">
				<div class="revestimientos">
					<h2>RECUBRIMIENTO BASE <small>ver m&aacute;s / <span>comprar</span></small></h2>
				</div> <!-- End of revestimientos -->
			</a>
