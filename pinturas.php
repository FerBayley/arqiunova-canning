		...
		<section class="contenidoCentral">
			...
			<a href="#">
				<div class="revestimientos">
					<h2>LATEX INTERIOR Y EXTERIOR <small>ver m&aacute;s / <span>comprar</span></small></h2>
				</div> <!-- End of revestimientos -->
			</a>

			<a href="#">
				<div class="revestimientos">
					<h2>SATINADO <small>ver m&aacute;s / <span>comprar</span></small></h2>
				</div> <!-- End of revestimientos -->
			</a>

			<a href="#">
				<div class="revestimientos">
					<h2>PREMIUM <small>ver m&aacute;s / <span>comprar</span></small></h2>
				</div> <!-- End of revestimientos -->
			</a>
