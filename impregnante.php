		...
		<section class="contenidoCentral">
			...
			<a href="#">
				<div class="revestimientos">
					<h2>TODO EN UNO <small>ver m&aacute;s / <span>comprar</span></small></h2>
				</div> <!-- End of revestimientos -->
			</a>

			<a href="#">
				<div class="revestimientos">
					<h2>SELLADOR <small>ver m&aacute;s / <span>comprar</span></small></h2>
				</div> <!-- End of revestimientos -->
			</a>

			<a href="#">
				<div class="revestimientos">
					<h2>FIJADOR <small>ver m&aacute;s / <span>comprar</span></small></h2>
				</div> <!-- End of revestimientos -->
			</a>
